...
1. **Что делать** — конкретный файл и что в нём должно быть
2. **Как это работает** — объяснение механики с описанием из официальной документации или практик
3. **Зачем это нужно** — место в архитектуре, почему именно так
4. **Ключевые термины/функции** — названия классов и методов для поиска в документации, с кратким описанием каждого
5. **Как проверить** — конкретный способ убедиться что всё работает

### База знаний

Все справочные материалы из постановок задач (описания концепций, термины, механика) дублируются в `docs/knowledge/`. Один файл — одна тема. Формат: Markdown. Цель — параллельно вести живую документацию проекта, которую можно читать независимо от чата.
